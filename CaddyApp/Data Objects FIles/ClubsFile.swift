...
let standardWoods: [String] = ["Driver", "3 Wood"]
let standardHybrids: [String] = ["4 Hybrid"]
let standardIrons: [String] = ["4 Iron", "5 Iron", "6 Iron", "7 Iron", "8 Iron", "9 Iron"]
let standardWedges: [String] = ["Pitching Wedge", "52 Wedge", "56 Wedge"]
